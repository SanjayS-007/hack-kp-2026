...
export const WAYPOINTS = [
  ...
  { id: 'nav-synthetic', selector: '[data-demo="nav-synthetic"]', caption: 'Synthetic Detection', note: 'DeepFake Shield', route: '/graph' },
  { id: 'synthetic-reanalyze', selector: '[data-demo="synthetic-reanalyze"]', caption: 'Re-analyze', note: '3-stream verdict 98.2%', route: '/synthetic' },
  { id: 'nav-report', selector: '[data-demo="nav-report"]', caption: 'Court Report', note: 'Automated §63 reporting', route: '/synthetic' },
  { id: 'report-generate', selector: '[data-demo="report-generate"]', caption: 'Generate report', note: 'HERAM 41/42 grounded', route: '/report' },
  { id: 'return-vault', selector: '[data-demo="return-vault"]', caption: 'Back to the Vault', note: 'Click the case chip — pull back to the Fusion Vault', route: '/report' },
