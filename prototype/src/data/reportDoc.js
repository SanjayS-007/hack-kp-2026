...
export const CUSTODY_LOG = [
  ...
  { t: '2026-06-28 10:03', actor: 'AEGIS-X ingest', action: `WORM commit · ${CANON.filesTotal.toLocaleString()} objects`, hash: 'merkle:7f3a…' },
...
const ECS_TEXTS = [
  ...
  `${CANON.filesTotal.toLocaleString()} objects were ingested and sealed to WORM storage.`,
  `${CANON.disposedPct}% of the corpus was auto-disposed by known-hash matching.`,
  `${CANON.flagged} artifacts were flagged across SAP categories A/B/C.`,
  `${CANON.flaggedA} artifacts were graded Category-A.`,
  `${CANON.highRisk} items were assessed high-risk.`,
  ...
  `${CANON.synthetic} files were assessed AI-generated.`,
